...
class Colors(BaseModelWithoutExtraKeys):
    body: Color = pydantic.Field(
        default=Color("rgb(25, 25, 30)"),
        description=(
            color_common_description + " The default value is `rgb(25, 25, 30)`."
        ),
        examples=color_common_examples,
    )
    name: Color = pydantic.Field(
        default=Color("rgb(10, 35, 90)"),
        description=color_common_description
        + " The default value is `rgb(10, 35, 90)`.",
        examples=color_common_examples,
    )
    headline: Color = pydantic.Field(
        default=Color("rgb(85, 95, 120)"),
        description=color_common_description
        + " The default value is `rgb(85, 95, 120)`.",
        examples=color_common_examples,
    )
    ...
    links: Color = pydantic.Field(
        default=Color("rgb(80, 155, 220)"),
        description=color_common_description
        + " The default value is `rgb(80, 155, 220)`.",
        examples=color_common_examples,
    )
    footer: Color = pydantic.Field(
        default=Color("rgb(155, 160, 180)"),
        description=color_common_description
        + " The default value is `rgb(155, 160, 180)`.",
        examples=color_common_examples,
    )
...
class FontSize(BaseModelWithoutExtraKeys):
    ...
    name: TypstDimension = pydantic.Field(
        default="32pt",
        description="The font size for the name. The default value is `32pt`.",
    )
    ...
    section_titles: TypstDimension = pydantic.Field(
        default="1.15em",
        description="The font size for section titles. The default value is `1.15em`.",
    )
    ...
    alignment: Literal["left", "justified", "justified-with-no-hyphenation"] = (
        pydantic.Field(
            ...
            description=(
                ...
                " breaks). The default value is `left`."
            ),
        )
    )
...
class SectionTitles(BaseModelWithoutExtraKeys):
    ...
    line_thickness: TypstDimension = pydantic.Field(
        default="0.8pt",
        description=length_common_description + " The default value is `0.8pt`.",
    )
    space_above: TypstDimension = pydantic.Field(
        default="0.6cm",
        description=length_common_description + " The default value is `0.6cm`.",
    )
    space_below: TypstDimension = pydantic.Field(
        default="0.25cm",
        description=length_common_description + " The default value is `0.25cm`.",
    )
...
class EducationEntry(BaseModelWithoutExtraKeys):
    main_column: str = pydantic.Field(
        default="**INSTITUTION** — DEGREE in *AREA*\nSUMMARY\nHIGHLIGHTS",
        description=(
...
class ExperienceEntry(BaseModelWithoutExtraKeys):
    main_column: str = pydantic.Field(
        ...
        description=(
            ...
            " text\n- `DATE`: Formatted date or date range\n\nYou can also add"
            " arbitrary keys to entries and use them as UPPERCASE placeholders.\n\nThe"
            " default value is `**POSITION** — COMPANY\\nSUMMARY\\nHIGHLIGHTS`."
        ),
    )
    date_and_location_column: str = pydantic.Field(
        default="DATE",
...
class ModernTheme(BaseModelWithoutExtraKeys):
    theme: Literal["modern"] = "modern"
