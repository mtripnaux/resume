...
#show: rendercv.with(
  ...
  entries-highlights-bullet: none,
  entries-highlights-nested-bullet: none,
  entries-highlights-space-left: 0pt,
  ...
  entries-highlights-space-between-bullet-and-text: 0pt,
  date: datetime(
